...
type BundleConfig() =
    static member RegisterBundles (bundles:BundleCollection) =
        bundles.Add(ScriptBundle("~/bundles/jquery").Include("~/Scripts/jquery/jquery-1.*"))

        bundles.Add(ScriptBundle("~/bundles/jqueryui").Include("~/Scripts/jquery-ui/jquery-ui*"))
        ...
        bundles.Add(ScriptBundle("~/bundles/modernizr").Include("~/Scripts/modernizr/modernizr-*"))
